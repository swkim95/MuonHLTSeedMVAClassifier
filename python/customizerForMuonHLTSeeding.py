...
def customizerFuncForMuonHLTSeeding(
    ...
    process.hltIter2Phase2L3FromL1TkMuonPixelSeedsFiltered = cms.EDProducer("MuonHLTSeedMVAClassifier",
        ...
        mvaFile_B_0 = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/DY_PU200_Binary_Barrel_NThltIter2FromL1.xml"),
        ...
        mvaFile_E_0 = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/DY_PU200_Binary_Endcap_NThltIter2FromL1.xml"),
