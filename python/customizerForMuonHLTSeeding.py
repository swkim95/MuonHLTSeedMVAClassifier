...
def customizerFuncForMuonHLTSeeding(
    ...
    process.hltIter2Phase2L3FromL1TkMuonPixelSeedsFiltered = cms.EDProducer("MuonHLTSeedMVAClassifier",
        ...
        mvaFile_B_0 = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/PU200_DYToLL_M50_Barrel_NThltIter2FromL1_0.xml"),
        mvaFile_B_1 = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/PU200_DYToLL_M50_Barrel_NThltIter2FromL1_1.xml"),
        mvaFile_B_2 = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/PU200_DYToLL_M50_Barrel_NThltIter2FromL1_2.xml"),
        mvaFile_B_3 = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/PU200_DYToLL_M50_Barrel_NThltIter2FromL1_3.xml"),
        mvaFile_E_0 = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/PU200_DYToLL_M50_Endcap_NThltIter2FromL1_0.xml"),
        mvaFile_E_1 = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/PU200_DYToLL_M50_Endcap_NThltIter2FromL1_1.xml"),
        mvaFile_E_2 = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/PU200_DYToLL_M50_Endcap_NThltIter2FromL1_2.xml"),
        mvaFile_E_3 = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/PU200_DYToLL_M50_Endcap_NThltIter2FromL1_3.xml"),
